...
export const fallbackConfig: FrankConfig = {
  ...
  models: [
    ...
    },
    {
      ...
      status: "ready",
      badge: "Native",
      max_resolution_label: "Native",
      description: "High-quality Gemini image generation/editing. Aspect ratio is hinted via prompt; output size is native.",
      capabilities: { generation: true, edit: true, masked_edit: false, video: false },
      allowed_aspect_ratios: ["1:1", "4:3", "3:4", "16:9", "9:16"],
      allowed_image_sizes: ["native"],
    ...
    },
    {
      ...
      badge: "Native",
      max_resolution_label: "Native",
      description: "Fast Gemini image generation/editing. Aspect ratio is hinted via prompt; output size is native.",
      capabilities: { generation: true, edit: true, masked_edit: false, video: false },
      allowed_aspect_ratios: ["1:1", "4:3", "3:4", "16:9", "9:16"],
      allowed_image_sizes: ["native"],
      reference_image_limit: 14,
