-- Frank Body Image Studio — initial schema
-- Run against your Supabase project (SQL editor or `supabase db push`).
-- Per-user privacy is enforced with RLS; image bytes live in a private bucket.
...
-- ---------------------------------------------------------------------------
-- assets (reference / generated / edited images; storage_path -> bucket)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- presets (brand prompt library — global, seeded; future admin editing)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- model_capabilities (read-only mirror of capabilities.ts for later tuning)
-- ---------------------------------------------------------------------------
...
-- (objects are keyed `<userId>/<sessionId>/<kind>/<assetId>.<ext>`)
-- ---------------------------------------------------------------------------
